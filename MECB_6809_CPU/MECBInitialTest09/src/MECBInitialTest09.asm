...
;
;******************************************************************************
Entry		EQU	$F000		; ROM code entry address
...
; Main Entry Point
		ORG	Entry
		LDS	#$0100	; Initialise Stack Pointer
		LDA	#$00	; Initialise Direct Page Register
		TFR	A,DP
; Setup VDP
		LDX	#GraphIModeRegs
		BSR	tfrAllVDPRegs
...
SkipRst		LDB	#7	; Write to VDP Register 7
		...
		LDX	#1992	; Delay approximately 2 seconds
...
;
GraphIModeRegs	FCB	$00		; Graphics I Mode
